...
export default function Home() {
 ...
 <main><p className="eyebrow">FOUNDATION TRACK</p><h1>Keep learning when the network leaves. </br> Evan Christopher 2024/1/96121ET Mechatronics Engineering </h1><p className="lede">Save a note, refresh the page, then test the same experience with the network turned off.</p>
